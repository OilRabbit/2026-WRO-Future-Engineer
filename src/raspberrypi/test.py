    ...
    while True:
        ...
        if reset_OC:
            ...
            # ==================================================================
                ...
                if time.time() - maneuver_start_time < 0.4:
            ...
            # ==================================================================
                ...
                if time.time() - maneuver_start_time < 0.1:
                    send_command_logged("8, 0, 0, parking step 1: forward")
                else:
                    send_command_logged("0, 0, 0, motor stop")
            ...
            # ==================================================================
                ...
                if time.time() - maneuver_start_time < 0.85:
                    steer = 95 if is_clockwise else -95
                    send_command_logged(f"-8, {steer}, 0, parking step 2: reverse turn 1")
                else:
                    send_command_logged("0, 0, 0, motor stop")
            ...
            # ==================================================================
                ...
                if time.time() - maneuver_start_time < 0.65:
                    # Speed -8 (backward), Steering 0 (straight)
                    send_command_logged("-8, 0, 0, parking step 2b: straight reverse")
                else:
                    send_command_logged("0, 0, 0, motor stop")
            ...
            # ==================================================================
                ...
                if time.time() - maneuver_start_time < 0.95:
                    steer = -95 if is_clockwise else 95
                    send_command_logged(f"-8, {steer}, 0, parking step 3: reverse turn 2")
                else:
                    send_command_logged("0, 0, 0, motor stop")
